...
export default {
  ...
  methods: {
    handleMovement () {
      const interval = 100
      this.timer = setInterval(() => this.detectMovement(interval), interval)
    },
    detectMovement (interval) {
...
export default {
  ...
  methods: {
    ...
    //     .then((result) => {
    //       /* eslint-disable no-console */
    //       console.log('dit is in detectmovement', result)
    //       /* eslint-enable no-console */
    //     })
    // },
    switchSegment (option) {
