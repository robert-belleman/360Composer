...
import ScenePlayerComponentAframe from './ScenePlayerComponentsAframe';
...
const ScenarioPlayerAframe:React.FC<ScenarioPlayerProps> = ({scenarioID, onFinish, onStart}:ScenarioPlayerProps) => {
  ...
  return (
    ...
    <div>
      <ScenePlayerComponentAframe sceneID={currentSceneID} onNextScene={onNextSceneAction} onSceneStart={onSceneStart} />
    </div>
  )
}

export default ScenarioPlayerAframe;
