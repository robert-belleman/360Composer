        ...
        <Container>
            <Grid container alignItems="center" >
                ...
                <Grid xs={12} className="paper textBox">
                    ...
                    only take a few minutes. <br></br> <br></br> Please enter the following information:
                </Grid>
                ...
                <Grid xs={12} className="paper textBox">
                    ...
                    <br/><br/>
                    In the first scene you will see a baboon and during the second and third scene you will see all orange if you did not use the enterVR button.
                    This is supposed to happen.
                    <br></br>
                    The image below is a preview of what you are roughly supposed to see.
                    <br></br>
                    Good luck and thank you for participating. 
                    <br></br>
                    <br></br>
                    <Button onClick={() => { startTest(); } } color="primary" variant="contained" >
                        Continue
                    </Button>
                </Grid>
                ...
                <Grid xs={12} className="paper textBox">
                    ...
                    <br></br>
                    <br></br>
                    <Button onClick={skip ? () => { skip() } : () => {} } color="primary" variant="contained">
                        Skip
                    </Button>
                </Grid>
            </Grid>
